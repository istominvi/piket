...
> Контекст организации задаётся **только путём**: все ресурсы вложены в `/orgs/{orgId}/...`.
> Заголовок ``X-Org-Id` (не используется)` и query‑параметры для org не используются.
